...
**Goal:** Turn PicCreator from a “prompt box + generator” into a design assistant that understands current project context, remembers user preferences, classifies chat intent, and produces executable generation/edit instructions.
