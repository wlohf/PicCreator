...
SESSION_COOKIE_NAME = "render_agent_session"
USER_NAMESPACE_HEADER = "x-render-agent-user-token"
SESSION_TTL_DAYS = 14
...
def get_request_namespace_user(request: Request) -> dict[str, Any] | None:
    raw_token = request.headers.get(USER_NAMESPACE_HEADER) or request.query_params.get("user_id") or ""
